...
const Card = ({ cardData, deleteEvent, shareEvent }) => {
  ...
  return (
    <>
            ...
            <div className="card-body d-flex flex-column">
              ...
              <div className="d-flex justify-content-between mt-auto">
                ...
                <button
                  ...
                  onClick={() => shareEvent(cardData)}
                  data-bs-toggle="modal"
                  data-bs-target={`#shareDoc${cardData?._id}`}
                >
      ...
      <Modal
        ...
        modalId={`shareDoc${cardData?._id}`}
        content={
          <>
            <p className="lead">
              Share this link to provide access to the document{" "}
              <strong>{cardData?.title}</strong>:
            </p>
            <div className="input-group">
              <input
                ...
                value={`http://localhost:5173/document/${cardData?._id}`}
                readOnly
              />
              <button
                ...
                onClick={() =>
                  navigator.clipboard.writeText(
                    `http://localhost:5173/document/${cardData?._id}`
                  )
                }
              >
                Copy
